...
theme.wallpaper                                 = "/home/volker/.config/awesome/themes/10-01_02-final.jpg"
theme.font                                      = "Dejavu Sans Bold 10"
theme.taglist_font                              = "Dejavu Sans Condensed Bold 9"
theme.fg_normal                                 = "#8DA0AD" -- "#FFFFFF"
theme.fg_focus                                  = "#8DA0AD" -- "#0099CC"
theme.bg_focus                                  = "#3D505D" -- "#303030"
theme.bg_normal                                 = "#202020" -- "#242424"
theme.fg_urgent                                 = "#CC9393"
theme.bg_urgent                                 = "#006B8E"
theme.border_width                              = dpi(3)
theme.border_normal                             = "#252525"
theme.border_focus                              = "#8DA0AD" -- "#0099CC"
theme.taglist_fg_focus                          = "#FFFFFF"
theme.tasklist_bg_normal                        = "#222222"
theme.tasklist_fg_focus                         = "#ADC0CD" -- "#4CB7DB"
theme.bg_widget                                 = "#303030" -- von Volker
...
local clockbg = wibox.container.background(mytextclock, theme.bg_widget, gears.shape.rectangle)
local clockwidget = wibox.container.margin(clockbg, dpi(0), dpi(3), dpi(5), dpi(5))

-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%d %b " .. markup.font("Dejavu Sans Mono 5", " ")))
local calendar_icon = wibox.widget.imagebox(theme.calendar)
local calbg = wibox.container.background(mytextcalendar, theme.bg_widget, gears.shape.rectangle)
local calendarwidget = wibox.container.margin(calbg, dpi(0), dpi(0), dpi(5), dpi(5))
theme.cal = lain.widget.cal({
    attach_to = { mytextcalendar }, -- { mytextclock, mytextcalendar },
    notification_preset = {
        fg = "#8DA0AD",
        bg = theme.bg_normal,
...
--     end
-- })
-- local musicbg = wibox.container.background(theme.mpd.widget, theme.bg_widget, gears.shape.rectangle)
...
local volumewidget = wibox.container.background(theme.volume.bar, theme.bg_widget, gears.shape.rectangle)
...
local cpubg = wibox.container.background(cpu.widget, theme.bg_widget, gears.shape.rectangle)
...
local netbg = wibox.container.background(net.widget, theme.bg_widget, gears.shape.rectangle)
local networkwidget = wibox.container.margin(netbg, dpi(0), dpi(0), dpi(5), dpi(5))

-- Weather
theme.weather = lain.widget.weather({
    city_id = 2911298, -- placeholder (Hamburg)
...
function theme.at_screen_connect(s)
    ...
    gears.wallpaper.centered(wallpaper, s, "#3D505D", 1)
    ...
    mytaglistcont = wibox.container.background(s.mytaglist, theme.bg_widget, gears.shape.rectangle)
    ...
    s.mywibox:setup {
        ...
        s.mytasklist, -- Middle widget -- nil, -- Middle widget
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
